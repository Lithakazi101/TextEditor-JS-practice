...
function updateText(){
  // CODE GOES HERE
  let textCopy = document.getElementById('text-input').value;
  document.getElementById('text-output').innerText = textCopy;
...
function makeUnderline(elem){
  elem.classList.toggle('.active');
  let x = document.getElementById('text-output');
  if( x.classList.contains('underline')){
